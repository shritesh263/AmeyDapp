/**
 * Shared Midnight.js providers for wallet-backed (Node) interactions.
 *
 * Used by the CLI and the demo script. The browser dapp builds its own
 * providers against the DApp Connector API instead.
 */
